...
pragmas += "// #pragma HLS ARRAY_PARTITION variable=thresholds" + str(
    layer['basemem']) + " complete dim=1\n"
			else:
pragmas += "// #pragma HLS ARRAY_PARTITION variable=factorA" + str(
    layer['basemem']) + " complete dim=1\n"
pragmas += "// #pragma HLS ARRAY_PARTITION variable=factorB" + str(
    layer['basemem']) + " complete dim=1\n"
